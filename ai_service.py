...
async def _call_inference(messages: List[Dict[str, str]], max_tokens: int = 512) -> Dict[str, Any]:
    ...
    model = os.getenv("DO_INFERENCE_MODEL", "openopenai-gpt-oss-120b")
    ...
    try:
        async with httpx.AsyncClient(timeout=90.0) as client:
            ...
            try:
                ...
                return {"note": "Failed to parse JSON from LLM response", "raw": json_text}
    except Exception as e:
        return {"note": "AI inference unavailable", "error": str(e)}
